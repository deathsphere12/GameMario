...
{
	// загружаем различные изображения и ресурсы D2D, которые еще не загружены
	if (tileSetImg == NULL)
	{
	...
	// вырисовываем "игра окончена" если больше не осталось жизней
	if (lives == 0)
	{
		rectangle1 = D2D1::RectF(
			0, 0,
	...
	// вырисовываем "поздравляю" если вы дошли до финальной точки
	if (success)
	{
		rectangle1 = D2D1::RectF(
			0, 0,
